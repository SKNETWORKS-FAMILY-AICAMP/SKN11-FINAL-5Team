    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-slate-50 to-gray-100">
      ...
      <section className="px-6 py-20">
        <div className="max-w-4xl mx-auto text-center">
          <Badge className="mb-6 bg-blue-100 text-blue-800 hover:bg-blue-100 text-[1.1em]">
            솔로프리너 전용 AI 어시스턴트
          </Badge>
          <h1 className="text-5xl md:text-7xl font-bold text-gray-900 mb-8 leading-tight">
            혼자서도
            <br />
            <span className="text-blue-600">한 팀처럼</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600">
              <span className="font-bold text-blue-600">예시 창업 여정</span>을 통해 TinkerBell의
              지원 과정을 확인해보세요
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <Card className="border-0 shadow-lg bg-white p-8">
              <div className="text-center">
                ...
                <Link href="/chat">
                  <Button className="bg-blue-600 hover:bg-blue-700 w-full mb-4">채팅 시작하기</Button>
                </Link>
                <div className="flex items-center justify-center text-sm text-gray-500">
                  <Clock className="h-4 w-4 mr-1" />
                  24시간 언제든지
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button
              variant="outline"
              size="lg"
              className="border-white text-white hover:bg-white hover:text-blue-600 text-lg px-8 py-3 rounded-full bg-transparent"
            >
              상담 예약하기
            </Button>
          </div>
