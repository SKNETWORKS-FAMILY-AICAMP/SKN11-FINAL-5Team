...
import { User, Lock, LogOut, Bell, CreditCard, FileText, HelpCircle, MessageSquare } from "lucide-react"
      ...
      <nav className="px-6 py-4 bg-white/90 backdrop-blur-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          <Link href="/" className="flex items-center space-x-3">
            <Image src="/tinkerbell-logo.png" alt="TinkerBell Logo" width={32} height={32} className="rounded-full" />
          ...
          <div className="flex items-center space-x-4">
            ...
            <Avatar className="h-8 w-8">
              ...
              <AvatarFallback className="bg-blue-100 text-blue-600">{profileData.name.charAt(0)}</AvatarFallback>
            </Avatar>
          </div>
        </div>
      </nav>
              ...
              <Card className="border-0 shadow-lg bg-white">
                ...
                <CardContent className="space-y-6">
                  ...
                  <div className="flex justify-end space-x-3">
                    ...
                    <Button className="bg-blue-600 hover:bg-blue-700">저장하기</Button>
                  </div>
                </CardContent>
              </Card>
            )}
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    <Card className="border-2 border-blue-200">
                      ...
                      <CardContent className="space-y-3">
                        ...
                        <Button className="w-full bg-blue-600 hover:bg-blue-700">업그레이드</Button>
                      </CardContent>
                    </Card>
