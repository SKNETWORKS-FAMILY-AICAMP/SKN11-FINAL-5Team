...
//위에가 main 브랜치의 mypage

// //report_down mypage에 리포트 마크다운일때도 되게 하는중
// "use client"
...
//       // 마크다운(ReactMarkdown 렌더된 영역 DOM 캡처)
...
//       }
//     } else {
//       // HTML(템플릿 변환)일 때 기존 방식
//       removePreviewDOM();
//       const tempDOM = createPreviewDOM(htmlPreview);

//       // 이하 기존 코드 동일 (html2canvas, jsPDF 로 캡처)
...
//       const canvas = await html2canvas(tempDOM, { scale: 2, useCORS: true, backgroundColor: null });
//       const pdf = new jsPDF({
...
//         let contentObj;
//         try {
//           contentObj = typeof contentJson === "string" ? JSON.parse(contentJson) : contentJson;
//         } catch {
//           contentObj = {};
//         }
...
//           setHtmlPreview(contentObj.markdown);
...
//           // contentJson 데이터 삽입 (setHtmlPreview 전에!)
...
//           setHtmlPreview("<p>템플릿을 불러올 수 없습니다.</p>");
//           setPreviewType("html");
//           setSelectedReport(report);
//           setIsPreviewOpen(true);
//         }
