    ...
    <div className="min-h-screen bg-[#044BD9] text-white relative">
      ...
      <div className="flex flex-col justify-center h-full px-16">
        <div className="flex items-center justify-between">
          {/* 중앙 좌측 텍스트 */}
          <div className="absolute left-[180px] top-[30%] text-white text-8xl font-bold drop-shadow-lg leading-tight">
            <h1 className="text-8xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)] leading-snug">
              혼자서도<br />충분해요!
            </h1>
          </div>
          ...
          <div className="absolute top-[9%] right-[5%] text-right">
            <p className="text-8xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)] leading-snug">
              당신의 든든한
            </p>
            <p className="text-8xl font-extrabold text-white drop-shadow-[0_4px_4px_rgba(0,0,0,0.5)] leading-snug">
              AI 비즈니스 팀
          ...
          <div className="absolute inset-0 flex justify-center items-center pointer-events-none">
            <img
              ...
              alt="고양이 일러스트"
              className="w-[1000px] h-auto drop-shadow-2xl"
            />
          </div>
        </div>
      </div>
      ...
      {/* 우측 하단 로고 */}
      <div className="absolute bottom-[9%] right-[2%] text-9xl font-extrabold text-white">
        TinkerBell
      </div>
    </div>
  );
